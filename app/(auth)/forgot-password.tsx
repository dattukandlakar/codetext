...
export default function ForgotPasswordScreen() {
  ...
  const handleSendOtp = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch('https://social-backend-zid2.onrender.com/user/forgotPassword', {
        method: 'POST',
        headers: {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      const response = await fetch('https://social-backend-zid2.onrender.com/user/verifyForgotPassword', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      const response = await fetch('https://social-backend-zid2.onrender.com/user/changePassword', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
