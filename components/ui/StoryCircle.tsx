...
interface StoryCircleProps {
  ...
  hasStories?: boolean;
  onPress: () => void;
  onAddStory?: () => void; // New prop for add story functionality
  size?: number;
  style?: ViewStyle;
  streak?: number;
  uploadProgress?: number;
  isUploading?: boolean;
  isAddStory?: boolean; // New prop to identify add story circle
  storyCount?: number; // New prop to show story count
}
...
export const StoryCircle: React.FC<StoryCircleProps> = ({
  ...
  // Animate the progress when uploadProgress changes
  React.useEffect(() => {
    if (isUploading) {
  ...
  return (
    ...
    >
      <View style={styles.storyContainer}>
        {/* Add Story Circle - Special case for creating new story */}
        {isAddStory ? (
          <View
            style={[
          ...
          // Unviewed Stories - Gradient border
          <LinearGradient
        ...
        {/* Story Count Badge */}
        {storyCount > 0 && !isAddStory && name === "Your Story" && (
          <View style={[
        ...
        {/* Live indicator for active uploads */}
        {isUploading && (
